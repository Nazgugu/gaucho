...
+ (void)initialize
{
    ...
    dispatch_once(&onceToken, ^ {
        ...
        appearance.titleColor = [UIColor darkGrayColor];
        ...
        appearance.cancelButtonFont = [UIFont systemFontOfSize:18.];
        appearance.customButtonColor = [UIColor colorWithRed:0.0f green:0.5f blue:1.0f alpha:1.0f];
