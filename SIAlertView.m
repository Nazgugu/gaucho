...
+ (void)initialize
{
    ...
    appearance.titleFont = [UIFont fontWithName:@"HelveticaNeue-Thin" size:20];
    appearance.messageFont = [UIFont fontWithName:@"HelveticaNeue-Thin" size:16];
    appearance.buttonFont = [UIFont fontWithName:@"HelveticaNeue-Thin" size:[UIFont buttonFontSize]];
