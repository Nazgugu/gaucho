...
- (void)setViews
{
    ...
    [titleLabel setFont:[UIFont fontWithName:@"HelveticaNeue-UltraLight" size:17.0f]];
    ...
    [messageLabel setFont:[UIFont fontWithName:@"HelveticaNeue-UltraLight" size:15.0f]];
    ...
    if (_positiveButtonTitle != nil) {
        ...
        [positiveButton.titleLabel setFont:[UIFont fontWithName:@"HelveticaNeue-UltraLight" size:17.0f]];
...
- (UIButton *)setButtonWithTitle:(NSString *)buttonTitle
{
    ...
    [button.titleLabel setFont:[UIFont fontWithName:@"HelveticaNeue-UltraLight" size:17.0f]];
