...
#define NA_SUBTITLE_FONT_SIZE            13.0f
...
- (id)initOnMapView:(NAMapView *)mapView {
    ...
    if (self) {        
        ...
        self.subtitleLabel.font            = [UIFont fontWithName:@"HelveticaNeue-UltraThin" size:NA_SUBTITLE_FONT_SIZE];
...
- (void)setAnnotation:(NAAnnotation *)annotation{
    ...
    if (annotation.subtitle) {
        CGSize subtitleSize = [annotation.subtitle sizeWithFont:[UIFont fontWithName:@"HelveticaNeue-Thin" size:NA_SUBTITLE_FONT_SIZE] constrainedToSize:CGSizeMake(maxWidth, NA_SUBTITLE_LABEL_HEIGHT) lineBreakMode:UILineBreakModeTailTruncation];
        
        middleWidth = MAX(subtitleSize.width, middleWidth);
        
        CGSize titleSize  = [annotation.title sizeWithFont:[UIFont fontWithName:@"HelveticaNeue-Thin" size:NA_TITLE_FONT_SIZE] constrainedToSize:CGSizeMake(maxWidth, NA_TITLE_LABEL_HEIGHT) lineBreakMode:UILineBreakModeTailTruncation];
        
        middleWidth = MAX(titleSize.width, middleWidth);
    }
    else{
        CGSize titleSize  = [annotation.title sizeWithFont:[UIFont fontWithName:@"HelveticaNeue-Thin" size:NA_TITLE_STANDALONE_FONT_SIZE] constrainedToSize:CGSizeMake(maxWidth, NA_TITLE_STANDALONE_LABEL_HEIGHT) lineBreakMode:UILineBreakModeTailTruncation];
    ...
    self.titleLabel.font  = [UIFont fontWithName:@"HelveticaNeue-Thin" size:titleFontSize];
