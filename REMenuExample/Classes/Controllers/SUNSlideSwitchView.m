...
- (void)createNameButtons
{
    ...
    for (int i = 0; i < [_viewArray count]; i++) {
        ...
        CGSize textSize = [vc.title sizeWithFont:[UIFont fontWithName:@"HelveticaNeue-Thin" size:kFontSizeOfTabButton]
        ...
        button.titleLabel.font = [UIFont fontWithName:@"HelveticaNeue-Thin" size:kFontSizeOfTabButton];
