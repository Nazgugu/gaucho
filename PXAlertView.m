              ...
              completion:(void(^) (BOOL cancelled))completion
{
    ...
    if (self) {
        ...
        _titleLabel.font = [UIFont fontWithName:@"HelveticaNeue-UltraLight" size:17];
        ...
        _messageLabel.font = [UIFont fontWithName:@"HelveticaNeue-UltraLight" size:15];
        ...
        if (otherTitle) {
            _cancelButton.titleLabel.font = [UIFont fontWithName:@"HelveticaNeue-UltraLight" size:17];
            ...
            _otherButton.titleLabel.font = [UIFont fontWithName:@"HelveticaNeue-Thin" size:17];
            ...
            _cancelButton.titleLabel.font = [UIFont fontWithName:@"HelveticaNeue-Thin" size:17];
